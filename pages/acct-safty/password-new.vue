<template>
	<view class="">
		<view class="cell-group-wrapper form-wrapper">
			<u-form label-width="auto" :model="setPwdForm" ref="setPwdForm" :error-type="['toast']">
				<u-form-item label="旧密码" prop="password">
					<u-input inputAlign="right" placeholder="请输入旧密码" type="password" v-model="setPwdForm.password" />
				</u-form-item>
				<u-form-item label="新密码" prop="newPassword">
					<u-input inputAlign="right" placeholder="请输入新密码" type="password" v-model="setPwdForm.newPassword" />
				</u-form-item>
			</u-form>
		</view>
		<view class="pwd-rule">
